...
EDM = {"bpm":128.0, "path":"songs/EDM Detection Mode 128.mp3", "offset":0.04}
...
function changeOriginAwareness(){
	level.zombieOriginAwareness = +document.getElementById("originAwareness").value;
}
