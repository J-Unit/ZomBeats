...
bool MainMenuScene::init()
{
	...
	auto startButton0 = MenuItemImage::create("textures/levelButton0.png", "textures/levelButton0.png", CC_CALLBACK_1(MainMenuScene::GoToGameScene0, this));
	...
	auto startButton1 = MenuItemImage::create("textures/levelButton1.png", "textures/levelButton1.png", CC_CALLBACK_1(MainMenuScene::GoToGameScene1, this));
	...
	auto startButton2 = MenuItemImage::create("textures/levelButton2.png", "textures/levelButton2.png", CC_CALLBACK_1(MainMenuScene::GoToGameScene2, this));
	...
	auto startButton3 = MenuItemImage::create("textures/levelButton3.png", "textures/levelButton3.png", CC_CALLBACK_1(MainMenuScene::GoToGameScene3, this));
...
void MainMenuScene::GoToGameScene0(cocos2d::Ref *sender)
{
...
{
	GameController* gc = GameController::create();
	gc->setCurrentLevel(2);
	gc->initEnvironment();
	Director::getInstance()->replaceScene(TransitionFade::create(0.5f, gc->view->scene));
}


void MainMenuScene::GoToGameScene3(cocos2d::Ref *sender)
{
	GameController* gc = GameController::create();
	gc->setCurrentLevel(3);
	gc->initEnvironment();
	Director::getInstance()->replaceScene(TransitionFade::create(0.5f, gc->view->scene));
}