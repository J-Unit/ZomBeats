...
public:
   ...
   // const Vec2& getThrust() { return inputThrust; }
	...
	const Vec2& getPos() { return inputPos; }

	const bool didClick() { return clicked; }

	const bool onBeat() { return insync; }
	...
	bool touchContinueCB(Touch* t, Event* event);

	void mouseContinuedCB(Event* event);
